...
--
-- Servidor: localhost
-- Tiempo de generación: 24-07-2013 a las 12:59:58
...
(34, 4, 'Introduccion a Photoshop', NULL, 0, NULL, '2013-07-19 08:52:33', '2013-07-23 15:13:54'),
(35, 4, 'Entorno de Photshop', NULL, 1, NULL, '2013-07-19 08:53:19', '2013-07-23 15:13:54'),
(36, 4, 'Herramientas de Pintura y Edicion', NULL, 2, NULL, '2013-07-19 08:53:48', '2013-07-23 15:13:54'),
(37, 4, 'Herramientas de Borrado', NULL, 3, NULL, '2013-07-19 08:54:06', '2013-07-23 15:13:54'),
(38, 4, 'Capas', NULL, 4, NULL, '2013-07-19 08:54:25', '2013-07-23 15:13:55');
...
--
-- Estructura de tabla para la tabla `content_pdfs`
--
...
INSERT INTO `content_texts` (`id`, `text_html`, `lesson_id`, `description`, `status_id`, `created_at`, `updated_at`) VALUES
(1, '', 14, NULL, NULL, NULL, NULL),
(2, 'configuracion en linux es por consola de comandos', 24, NULL, NULL, '2013-07-24 09:51:13', NULL),
(3, 'configuracion en linux es por consola de comandos', 24, NULL, NULL, '2013-07-24 09:51:19', NULL),
(4, 'configuracion en linux es por consola de comandos', 24, NULL, NULL, '2013-07-24 09:51:21', NULL),
(5, 'configuracion en linux es por consola de comandos', 24, NULL, NULL, '2013-07-24 09:51:21', NULL),
(6, 'configuracion en linux es por consola de comandos', 24, NULL, NULL, '2013-07-24 09:51:22', NULL),
(7, 'configuracion en linux es por consola de comandos', 24, NULL, NULL, '2013-07-24 09:51:22', NULL);
...
--
-- Volcado de datos para la tabla `content_videos`
--

INSERT INTO `content_videos` (`id`, `lesson_id`, `file_name`, `file_size`, `file_type`, `type`, `url`, `pause`, `created_at`, `updated_at`) VALUES
(1, 24, NULL, NULL, NULL, 'youtube', 'http://www.youtube.com/watch?v=e1aNl4NFAMk', NULL, '2013-07-24 09:52:01', NULL);
...
(3, NULL, NULL, NULL, 201, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 10, '2013-06-25 15:52:46', '2013-07-10 00:32:46', 'Microsof PowerPoint 2013', 'Cree, disennie e impacte a sus clientes con las mejores presentaciones del mercado.', 'photoshop, adobe premier, gimp', '0', '0'),
(4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11, '2013-06-25 20:53:13', NULL, 'Photoshop', 'Edicion de imagenes de alta calidad mediante tecnologias de diseño', NULL, NULL, NULL),
...
(6, NULL, NULL, NULL, 1000, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 10, '2013-07-10 03:48:42', '2013-07-10 03:56:35', 'Excel 2013', 'Programacion en excel 2013, funciones, graficos, y mas.', 'java, clases, objetos, programacion, web', '0', '0'),
...
(8, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11, '2013-07-23 10:33:19', NULL, 'Sexo Tantrico', NULL, NULL, NULL, NULL);
...
--
-- Volcado de datos para la tabla `course_faqs`
--

INSERT INTO `course_faqs` (`id`, `question`, `answer`, `course_id`, `created_at`, `updated_at`) VALUES
(1, 'Es posible crear imagenes GIF con Photoshop', 'si es posible', 4, '2013-07-23 00:00:00', NULL),
(2, 'como cambiar la imagen de fondo de una fotografia', 'Es simple. Se utilizan las capas. Se debe cortar primeramente la imagen principal, por ejemplo una persona, y luego con una capa ponemos el fondo que deseamos. Tenemos dos capas, la del fondo y la del personaje.', 4, '2013-07-23 00:00:00', NULL),
(3, 'otra pregunta', 'y esta es la respuesta', 4, '2013-07-24 00:00:00', NULL);
...
--
-- Estructura de tabla para la tabla `course_testimonies`
--

CREATE TABLE IF NOT EXISTS `course_testimonies` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `course_testimonies`
--

INSERT INTO `course_testimonies` (`id`, `testimony`, `course_id`, `created_at`, `updated_at`, `user_id`) VALUES
(1, 'Desde la Base de datos. Es increible lo que logre aprender con este curso. Realmente siento ahora que puedo mostrar al mundo como veo las cosas con Photoshop.', 4, '2013-07-24 00:00:00', '0000-00-00 00:00:00', 11),
(2, 'este es un comentario de un testimonio', 4, '2013-07-24 00:00:00', '0000-00-00 00:00:00', 11);
...
(5, 4, 'course_thumbnail_4.jpg', '66.47', 'image/jpeg', '2013-07-18 10:46:48', NULL);
...
(1, 3, 11, 'Curso numero 6 ', 1, 'perfeckt', 1, '2013-07-17 00:00:00', NULL),
...
(15, 34, 'Que es Photoshop', NULL, 0, NULL, '2013-07-19 08:55:24', NULL),
(16, 34, 'Iniciando Photoshop', NULL, 0, NULL, '2013-07-19 08:56:54', NULL),
(17, 34, 'abrir una imagen', NULL, 0, NULL, '2013-07-19 08:57:07', NULL),
(19, 35, 'variables del sistema', NULL, 0, NULL, '2013-07-23 15:14:06', NULL),
(20, 36, 'pinceles', NULL, 0, NULL, '2013-07-23 15:14:19', NULL),
(21, 36, 'herramientas', NULL, 0, NULL, '2013-07-23 15:14:29', NULL),
(22, 38, 'Evaluacion', NULL, 0, NULL, '2013-07-24 08:55:55', NULL),
(23, 37, 'Tipos de gomas', NULL, 0, NULL, '2013-07-24 09:06:36', NULL),
(24, 35, 'linux', NULL, 0, NULL, '2013-07-24 09:50:08', NULL),
(25, 35, 'mac', NULL, 0, NULL, '2013-07-24 09:50:17', NULL);
...
('f2c5d55b43f50c4137dc5fa0b000dbeb', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1500.72 Safari/537.36', 1374670589, 'a:8:{s:9:"user_data";s:0:"";s:9:"logged_in";b:1;s:10:"user_email";s:20:"esteban.jr@gmail.com";s:7:"user_id";i:11;s:9:"user_name";s:6:"walter";s:12:"user_surname";s:12:"juarez rivas";s:15:"user_lastaccess";s:19:"2013-07-23 11:58:57";s:7:"role_id";s:1:"4";}');
...
(11, 'walter', 'juarez rivas', 'esteban.jr@gmail.com', 1, 1374655381, '2013-07-16 12:57:19', '2013-07-24 08:43:01', 0, 1, NULL, NULL, NULL, 1, '', '', '', '0000-00-00 00:00:00', 'estebanjr', '6b0279d0769d46c40579985992c06744', 4, NULL, NULL, 'SogYL7YY37f3QcLhiTXHnXc5RWXuEkPtURUuMeRYpmfiZ1Vk6VW', NULL, NULL, NULL, NULL);
...
ALTER TABLE `chapters`
  ADD CONSTRAINT `chapters_course_id` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Filtros para la tabla `content_pdfs`
--
ALTER TABLE `content_pdfs`
  ADD CONSTRAINT `content_pdfs_lesson_id` FOREIGN KEY (`lesson_id`) REFERENCES `lessons` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Filtros para la tabla `course_testimonies`
--
ALTER TABLE `course_testimonies`
  ADD CONSTRAINT `fk_course_terminies_courses` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `lessons`
  ADD CONSTRAINT `lessons_chapter_id` FOREIGN KEY (`chapter_id`) REFERENCES `chapters` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
