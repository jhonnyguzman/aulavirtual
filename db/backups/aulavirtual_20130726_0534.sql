...
INSERT INTO `aulavirtual`.`chapters` VALUES  (1,3,'¿Qué es PHP?',NULL,2,NULL,'2013-07-15 23:34:44','2013-07-25 15:42:22'),
...
--
-- Definition of table `aulavirtual`.`content_pdfs`
--

DROP TABLE IF EXISTS `aulavirtual`.`content_pdfs`;
CREATE TABLE  `aulavirtual`.`content_pdfs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `lesson_id` int(11) NOT NULL,
  `file_name` text,
...
--
-- Dumping data for table `aulavirtual`.`content_pdfs`
--

/*!40000 ALTER TABLE `content_pdfs` DISABLE KEYS */;
LOCK TABLES `content_pdfs` WRITE;
INSERT INTO `aulavirtual`.`content_pdfs` VALUES  (6,40,'461510ecaa7039d6970529d0abbdabb3_40.pdf','819.15','application/pdf',NULL,'2013-07-25 05:12:16',NULL);
UNLOCK TABLES;
...
INSERT INTO `aulavirtual`.`content_texts` VALUES  (8,'&lt;font color=&quot;#16a765&quot; size=&quot;5&quot;&gt;&lt;b&gt;ponemos algo aqui&amp;nbsp;&lt;/b&gt;&lt;/font&gt;',35,NULL,NULL,'2013-07-24 05:06:50',NULL),
...
INSERT INTO `aulavirtual`.`content_videos` VALUES  (1,36,'f056a155e13a2ba71bca172d8576dd11_36.avi','5183.13','video/x-msvideo','local',NULL,NULL,'2013-07-24 20:07:18',NULL),
...
--
-- Definition of table `aulavirtual`.`course_sliders`
--

DROP TABLE IF EXISTS `aulavirtual`.`course_sliders`;
CREATE TABLE  `aulavirtual`.`course_sliders` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `aulavirtual`.`course_sliders`
--
...
--
-- Definition of table `aulavirtual`.`course_testimonies`
--

DROP TABLE IF EXISTS `aulavirtual`.`course_testimonies`;
CREATE TABLE  `aulavirtual`.`course_testimonies` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `aulavirtual`.`course_testimonies`
--
...
INSERT INTO `aulavirtual`.`course_users` VALUES  (1,3,10,'',0,'',1,NULL,NULL);
UNLOCK TABLES;
...
INSERT INTO `aulavirtual`.`lessons` VALUES  (21,'Inicios',NULL,3,NULL,'2013-07-15 23:45:58','2013-07-25 14:00:38',1),
...
--
-- Definition of table `aulavirtual`.`moneys`
--

DROP TABLE IF EXISTS `aulavirtual`.`moneys`;
CREATE TABLE  `aulavirtual`.`moneys` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `aulavirtual`.`moneys`
--

/*!40000 ALTER TABLE `moneys` DISABLE KEYS */;
LOCK TABLES `moneys` WRITE;
INSERT INTO `aulavirtual`.`moneys` VALUES  (3,'ARS',NULL,NULL),
 (2,'EUR',NULL,NULL),
 (1,'USD',NULL,NULL);
UNLOCK TABLES;
...
INSERT INTO `aulavirtual`.`sessions` VALUES  ('ca3bc5bc9d79589c01918348d87fc93d','127.0.0.1','Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.22 (KHTML, like Gecko) Ubuntu Chromium/25.0.1364.160 Chrome/25.0.1364.160 ',1374827398,'a:9:{s:9:\"user_data\";s:0:\"\";s:9:\"logged_in\";b:1;s:10:\"user_email\";s:22:\"guzmanjhonny@gmail.com\";s:7:\"user_id\";i:10;s:9:\"user_name\";s:6:\"Johnny\";s:12:\"user_surname\";s:6:\"Guzman\";s:15:\"user_lastaccess\";s:19:\"2013-07-25 23:54:38\";s:7:\"role_id\";s:1:\"4\";s:11:\"user_avatar\";s:87:\"http://localhost/repositorios/aulavirtual/uploads/user_thumbnails/user_thumbnail_10.png\";}');
UNLOCK TABLES;
...
INSERT INTO `aulavirtual`.`user_categories` VALUES  (1,'Estudiante','Como estudiante'),
...
INSERT INTO `aulavirtual`.`user_thumbnails` VALUES  (5,10,'user_thumbnail_10.png','3.71','image/png','2013-06-25 00:59:13','2013-07-26 03:17:29');
UNLOCK TABLES;
...
INSERT INTO `aulavirtual`.`users` VALUES  (1,'John','Smith','john.smith@example.com',1,1374629015,'0000-00-00 00:00:00','2013-07-10 02:44:06',0,1,NULL,NULL,NULL,NULL,'','','','0000-00-00 00:00:00','admin','21232f297a57a5a743894a0e4a801fc3',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
