...
INSERT INTO `aulavirtual`.`resources` VALUES  (1,'controller','login',NULL,NULL,0,NULL,NULL,NULL),
...
INSERT INTO `aulavirtual`.`roles` VALUES  (1,'Administrator',NULL,'cizacl','',0,1,'0000-00-00 00:00:00','0000-00-00 00:00:00'),
 (2,'Guest',NULL,'login',NULL,1,2,'0000-00-00 00:00:00','0000-00-00 00:00:00');
UNLOCK TABLES;
...
INSERT INTO `aulavirtual`.`rules` VALUES  (1,1,'allow','[null]','[null]',1,'',NULL,NULL),
 (2,2,'allow','[\"login\"]','[null]',1,'',NULL,NULL);
UNLOCK TABLES;
...
INSERT INTO `aulavirtual`.`sessions` VALUES  ('411d264f80cd4a195ae159b7fda6edea','127.0.0.1','Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.22 (KHTML, like Gecko) Ubuntu Chromium/25.0.1364.160 Chrome/25.0.1364.160 ',1371767357,'a:5:{s:7:\"user_id\";s:1:\"1\";s:9:\"user_name\";s:4:\"John\";s:12:\"user_surname\";s:5:\"Smith\";s:15:\"user_lastaccess\";s:1:\"1\";s:7:\"role_id\";s:1:\"1\";}');
UNLOCK TABLES;
...
CREATE TABLE  `aulavirtual`.`users` (
  ...
  PRIMARY KEY (`id`),
  KEY `users_adress_id` (`adress_id`),
  KEY `users_despath_id` (`despath_id`),
  KEY `users_role_id` (`role_id`),
  KEY `users_telephone_id` (`telephone_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `aulavirtual`.`users` VALUES  (1,'John','Smith','john.smith@example.com',1,1371767054,'0000-00-00 00:00:00','0000-00-00 00:00:00',0,1,NULL,NULL,NULL,NULL,'','',0,'',0,'0000-00-00 00:00:00',NULL,'admin','21232f297a57a5a743894a0e4a801fc3',1,NULL,NULL,NULL,NULL);
UNLOCK TABLES;
