...
<div id="container">
	...
	<table width="100%" cellpadding="5" cellspacing="0">
		...
		<tr>
			...
			<td><strong><?php echo $row->surname?></strong></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><strong><?php echo $row->role_name?></strong></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><strong><?php echo $this->cizacl_mdl->getUser($row->added_by)?></strong></td>
		</tr>
		<tr>
			<td><?php echo $this->lang->line('added_on')?></td>
			<td><strong><?php echo $this->cizacl_mdl->mktime_format($row->added)?></strong></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr>
			...
			<td><strong><?php echo $this->cizacl_mdl->getUser($row->edited_by,'')?></strong></td>
		</tr>
		<tr>
			<td><?php echo $this->lang->line('edited_on')?></td>
			<td><strong><?php echo $this->cizacl_mdl->mktime_format($row->edited)?></strong></td>
		</tr>
	</table>
</div>
</body>
