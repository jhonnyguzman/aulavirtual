...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
  <head>
    ...
    <link rel="stylesheet" href="<?=base_url()?>assets/js/pdf/viewer.css"/>
    ...
    <script type="text/javascript" src="<?=base_url()?>assets/js/pdf/compatibility.js"></script>

    <!-- This snippet is used in production, see Makefile -->
    <link rel="resource" type="application/l10n" href="<?=base_url()?>assets/js/pdf/locale/es/locale.properties"/>
    <script type="text/javascript" src="<?=base_url()?>assets/js/pdf/l10n.js"></script>
    <script type="text/javascript" src="<?=base_url()?>assets/js/pdf/pdf.js"></script>
    <script type="text/javascript" src="<?=base_url()?>assets/js/pdf/debugger.js"></script>
    <script type="text/javascript" src="<?=base_url()?>assets/js/pdf/viewer.js"></script>
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              <div id="toolbarViewerLeft">
                ...
                <label id="pageNumberLabel" class="toolbarLabel" for="pageNumber" data-l10n-id="page_label">Pag.: </label>
              ...
              <div id="toolbarViewerRight">
                ...
                <button id="presentationMode" class="toolbarButton presentationMode hiddenSmallView" title="Switch to Presentation Mode" tabindex="12" data-l10n-id="presentation_mode">
                  <span data-l10n-id="presentation_mode_label">Modo Presentaci&oacute;n</span>
                </button>
                ...
                <!-- <div class="toolbarButtonSpacer"></div> -->
                <a href="#" id="viewBookmark" class="toolbarButton bookmark hiddenSmallView" title="Current view (copy or open in new window)" tabindex="16" data-l10n-id="bookmark"><span data-l10n-id="bookmark_label">Vista Actual</span></a>
              </div>
                ...
                <div class="innerCenter" id="toolbarViewerMiddle">
                  ...
                  <span id="scaleSelectContainer" class="dropdownToolbarButton">
                     <select id="scaleSelect" title="Zoom" oncontextmenu="return false;" tabindex="11" data-l10n-id="zoom">
                      <option id="pageAutoOption" value="auto" selected="selected" data-l10n-id="page_scale_auto">Autom&aacute;tico</option>
                      <option id="pageActualOption" value="page-actual" data-l10n-id="page_scale_actual">Tama&ntilde;o actual</option>
                      <option id="pageFitOption" value="page-fit" data-l10n-id="page_scale_fit">Pag. completa</option>
                      <option id="pageWidthOption" value="page-width" data-l10n-id="page_scale_width">Ajustar en ancho</option>
